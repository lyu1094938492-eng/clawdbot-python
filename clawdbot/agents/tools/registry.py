...
class ToolRegistry:
    ...
    def _register_default_tools(self) -> None:
        ...
        self.register(CronTool(on_trigger=self.cron_callback))
...
def get_tool_registry(
    session_manager: Any | None = None, cron_callback: Any | None = None
) -> ToolRegistry:
    """Get global tool registry"""
    global _global_registry
    if _global_registry is None:
        _global_registry = ToolRegistry(
            session_manager=session_manager, cron_callback=cron_callback
        )
